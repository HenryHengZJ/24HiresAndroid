...
import com.zjheng.jobseed.jobseed.SearchTalentScene.FilterTalent;
...
public class ExploreJobFragment extends Fragment {
    ...
    private static final String TAG = "ExploreJobFragment";
    ...
    public static ExploreJobFragment newInstance(String city) {
        ExploreJobFragment result = new ExploreJobFragment();
