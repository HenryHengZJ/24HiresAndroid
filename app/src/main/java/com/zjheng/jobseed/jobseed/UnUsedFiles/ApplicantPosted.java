...
public class ApplicantPosted extends Fragment {
    ...
    private DatabaseReference mJob, mUserPosted;

    private static final String TAG = "ApplicantUserPosted";
    ...
    public static ApplicantPosted newInstance(String userid) {
        ApplicantPosted result = new ApplicantPosted();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        rootView = inflater.inflate(R.layout.applicantpostedtab, container, false);
